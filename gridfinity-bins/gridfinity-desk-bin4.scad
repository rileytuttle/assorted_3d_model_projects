...
gridfinityInit(gridx, gridy, height(gridz, gridz_define, 0, enable_zsnap), height_internal, sl=0, l=[l_gridx, l_gridy]) {
    // flush cutters
    left(25) up(gridz*7) cuboid([13, 28, 42], anchor=TOP, spin=0, chamfer=-2);
    // little pliers
    left(5) up(gridz*7) cuboid([8, 12, 42], anchor=TOP, chamfer=-2);
    // scissors
    right(20) up(gridz*7) cuboid([15, 30, 42], anchor=TOP, chamfer=-2);
}
